...
const CSS = `
  :root {
    --ground: #0a1830; --surface: #12233f; --surface-2: #1a2d4e; --card: #132542;
    --ink: #f2f6fc; --ink-soft: #9fb4d6; --ink-faint: #6c82a8;
    --accent: #1e6feb; --accent-ink: #ffffff; --cta: #ffc61a; --cta-ink: #17120a; --clay: #e67a3e;
    --ring: rgba(242, 246, 252, 0.12); --ring-strong: rgba(242, 246, 252, 0.24); --shadow: rgba(3, 9, 20, 0.6);
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  .btn-primary { background: var(--cta); color: var(--cta-ink); box-shadow: 0 4px 18px color-mix(in srgb, var(--cta) 45%, transparent); }
...
const FLAGSHIP_CSS = `
  ...
  @keyframes cta-pulse { 0%, 100% { box-shadow: 0 4px 18px color-mix(in srgb, var(--cta) 45%, transparent); } 50% { box-shadow: 0 4px 32px color-mix(in srgb, var(--cta) 80%, transparent); } }
